...
path='D:\Work\FreelancerProjects\Image Compression\CASIA-IrisV1\CASIA Iris Image Database (version 1.0)\00'; %please update to your directory
subpath='00'; %please update to your directory
for i=1:108
    
            if i>=10
                path='D:\Work\FreelancerProjects\Image Compression\CASIA-IrisV1\CASIA Iris Image Database (version 1.0)\0';
                subpath='0';
            end
            
            if i>=100
                 path='D:\Work\FreelancerProjects\Image Compression\CASIA-IrisV1\CASIA Iris Image Database (version 1.0)\';
                 subpath='';
            end
    ...
    for j=1:2
        ...
        out = imagecompression(im,2,'haar');
        end
        end
